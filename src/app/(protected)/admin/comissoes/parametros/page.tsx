...
export default async function AdminComissoesParametrosPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h2 className="text-xl font-semibold">Parâmetros de comissão</h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Percentual padrão da marca para vendedores sem taxa própria no cadastro.
        </p>
      </div>
